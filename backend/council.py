...
async def stage1_collect_responses(user_query: str, models: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """
...
async def stage3_synthesize_final(
    ...
    Args:
        ...
        chairman: Chairman model configuration
...
async def run_full_council(
    ...
    Args:
        user_query: The user's question
        models: List of model configurations for the council
        chairman: Chairman model configuration
